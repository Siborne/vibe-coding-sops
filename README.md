...
> AI 辅助编程（vibe coding）规则集合。每条规则说清楚"做什么"，每条规则的原因解释回答"为什么"。
...
| 7 | [Branch & PR Workflow](rules/branch-pr-workflow.md) | 分支命名、PR 范围、rebase 同步、合并前 checklist、reviewer 合并后清理 |
...
每条规则对应的"为什么"详见 [rationale/rules/zh/](rationale/rules/zh/) 目录。
